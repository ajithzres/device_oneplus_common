...
public class OnePlusSettingsSearchIndexablesProvider extends SearchIndexablesProvider {
    private String TAG = "OPSettings-SearchIndexablesProvider";
    ...
    public Cursor queryXmlResources(String[] projection) {
        ...
        matrixCursor.addRow(generateResourceRef(new SearchIndexableResource(1, R.xml.fragment_main, MainActivity.class.getName(), R.drawable.ic_launcher)));
    ...
    private static Object[] generateResourceRef(SearchIndexableResource searchIndexableResource) {
        ...
        ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = "com.oneplus.settings";
